                        ...
                        <div>
                            ...
                            {loadingOrders ? (
                                ...
                                <div className="text-center py-10 bg-[#f4f7f9] border border-[#cad4e4]">
                                    ...
                                    <button onClick={() => navigate("/shop")} className="text-orange font-semibold hover:underline">Start Shopping</button>
                                </div>
                            ) : (
                        ...
                        <div>
                            ...
                            {wishlist.length === 0 ? (
                                <div className="text-center py-10 bg-[#f4f7f9] border border-[#cad4e4]">
                                    ...
                                    <button onClick={() => navigate("/shop")} className="text-orange font-semibold hover:underline">Browse Products</button>
                                </div>
                            ) : (
                    ...
                    {activeTab === "quotes" && (
                        <div>
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <button onClick={() => navigate("/get-a-quote")} className="px-4 h-10 bg-orange text-white text-sm font-semibold hover:bg-orange-hover transition-colors">
                                    + New Quote
                                </button>
                            </div>
                            {loadingQuotes ? (
                                ...
                                <div className="text-center py-10 bg-[#f4f7f9] border border-[#cad4e4]">
                                    ...
                                    <button onClick={() => navigate("/get-a-quote")} className="text-orange font-semibold hover:underline">Request a Quote</button>
                                </div>
                            ) : (
                                <div className="space-y-4">
