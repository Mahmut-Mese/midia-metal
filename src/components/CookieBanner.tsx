                ...
                <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-[#8ab0d1] leading-relaxed">
                            We use cookies to enhance your browsing experience, remember your cart, and analyse site traffic.
                            By clicking "Accept", you consent to our use of cookies.
                            You can learn more in our{" "}
                            <Link to="/privacy-policy" className="underline text-orange hover:text-orange/80">Privacy Policy</Link>.
                        </p>
                    </div>
                </div>
                <div className="flex items-center gap-3 flex-shrink-0">
                    <button onClick={decline} className="text-xs text-[#8ab0d1] hover:text-white transition-colors px-3 py-2">
                        Decline
                    </button>
                    <button onClick={accept} className="text-xs font-semibold bg-orange text-white px-5 py-2.5 rounded hover:bg-[#d4500b] transition-colors">
                        Accept All
                    </button>
                    <button onClick={decline} className="text-[#8ab0d1] hover:text-white p-1" aria-label="Close">
                        <X className="w-4 h-4" />
                    </button>
                </div>
            </div>
