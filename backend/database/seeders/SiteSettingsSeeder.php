...
class SiteSettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'footer_newsletter_title', 'value' => 'Newsletter', 'type' => 'text', 'group' => 'general'],
            ['key' => 'footer_newsletter_desc', 'value' => 'Get the latest updates and offers from Midia M Metal.', 'type' => 'textarea', 'group' => 'general'],
            ...
            ['key' => 'footer_label_newsletter', 'value' => 'Newsletter', 'type' => 'text', 'group' => 'general'],
